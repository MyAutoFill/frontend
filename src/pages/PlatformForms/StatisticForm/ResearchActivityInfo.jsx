...
export default function ResearchActivityInfo(props) {
  ...
  const load_data = (curDate) => {
    ...
    reqBasicData(curDate, uuid)
      .then(function (res) {
        reqRatioConfig('ResearchActivityInfo')
    ...
    <>
      ...
      <div size='large' style={{height: 800, padding: 10, overflow:'auto'}} class="banner-anim">
        <Form onFinish={onFinish} form={form}>
          <Descriptions style={{width: '1300px'}} title="研究开发活动及相关情况信息" bordered items={items} />
          <FloatButton.Group
            open={defaultOpen}
            trigger="click"
            style={{
