...
export default function IndividualAccountInfo(props) {
  ...
  const load_data = (curDate) => {
    ...
    reqBasicData(curDate, uuid)
      .then(function (res) {
        reqRatioConfig('IndividualAccountInfo')
  ...
  const onFinish = (values) => {
    request('/api_test/get_ratio_config?table=IndividualAccountInfo', {
      method: 'GET',
    })
    .then(function (config) {
    ...
    <>
      ...
      <div size='large' style={{height: 800, padding: 10, overflow:'auto'}} class="banner-anim">
        <Form onFinish={onFinish} form={form}>
          <Descriptions style={{width: '1300px'}} title="个人账户信息" bordered items={items} />
          <FloatButton.Group
            open={defaultOpen}
            trigger="click"
            style={{
