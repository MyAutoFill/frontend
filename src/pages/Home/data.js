...
const options = [
  ...
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=42', label: '人社局 > 单位基本信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=36', label: '人社局 > 单位就业登记信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=37', label: '人社局 > 以工代训补贴申领信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=39', label: '人社局 > 单位参保信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=6', label: '统计局 > 单位基本信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=7', label: '统计局 > 单位从业人员及工资总额信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=8', label: '统计局 > 研究开发项目情况信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=9', label: '统计局 > 研究开发活动及相关情况信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=10', label: '统计局 > 财务状况信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=caizheng1', label: '财政局 > 企业基本信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=15', label: '市场监督管理局 > 企业基本信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=16', label: '市场监督管理局 > 资产状况信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=17', label: '市场监督管理局 > 对外提供保证担保信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=18', label: '市场监督管理局 > 参保信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=haiguan1', label: '威海海关 > 企业基本信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=27', label: '科技局 > 企业概况信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=28', label: '科技局 > 企业经济概况信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=29', label: '科技局 > 企业人员概况信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=39', label: '科技局 > 研究开发项目状况信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=31', label: '科技局 > 研究开发活动及相关情况信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=32', label: '科技局 > 法人基本信息表' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=33', label: '工信局 > 软件和信息技术服务企业月报' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=shangwu1', label: '商务局 > 企业基本信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=1', label: '税务局 > 单位税务信息' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=2', label: '税务局 > 利润表' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=3', label: '税务局 > 资产负债表' },
  { value: 'https://xcyb.weihai.cn/auto_fill/input?tab=2&table=4', label: '税务局 > 现金流量表' },
];

const AutoCompleteExample = () => {
  const [value, setValue] = useState(null);
  const [curStatus, setCurStatus] = useState(null);
  const [web, setWeb] = useState('/auto_fill/input?tab=2&table=42')
